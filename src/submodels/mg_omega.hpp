...
struct mg_omega {
    ...
    class MGOmegaCodonMatrixProxy final : public Proxy<MGOmegaCodonSubMatrix&> {
      ...
      public:
        MGOmegaCodonMatrixProxy(
            const CodonStateSpace* statespace, NucMatrixSelector nucmatrix, OmegaSelector omega)
            : _mat(statespace, &nucmatrix(), omega(), false), _nucmatrix(nucmatrix), _omega(omega) {
            gather();
        }
    ...
    class MGOmegaCodonMatrixArrayProxy final : public Proxy<MGOmegaCodonSubMatrix&, int> {
      ...
      public:
        MGOmegaCodonMatrixArrayProxy(const CodonStateSpace* statespace, NucMatrixSelector nucmatrix,
            OmegaSelector omega, Size n)
    ...
    static auto make(
        const CodonStateSpace* statespace, NucMatrixSelector nucmatrix, OmegaSelector omega) {
        auto codon_matrix =
            std::make_unique<MGOmegaCodonMatrixProxy<NucMatrixSelector, OmegaSelector>>(
                statespace, nucmatrix, omega);
    ...
    // make an array proxy
    template <class NucMatrixSelector, class OmegaSelector, class Size>
    static auto make(const CodonStateSpace* statespace, NucMatrixSelector nucmatrix,
        OmegaSelector omega, Size n) {
        auto codon_matrix_array =
            std::make_unique<MGOmegaCodonMatrixArrayProxy<NucMatrixSelector, OmegaSelector, Size>>(
                statespace, nucmatrix, omega, n);

        return codon_matrix_array;
