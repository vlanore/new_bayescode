...
class ContinuousData	{
	...
	void ToStream(std::ostream& os, TaxonSet* taxset = 0) const {
	...
	void ToStreamLog(std::ostream& os) const {
...
class FileContinuousData : public ContinuousData {
	...
	public:
		FileContinuousData(std::istream& is)	{
			ReadDataFromFile(is);
		}
